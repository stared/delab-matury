...
Na koniec warto wspomnieć o jeszcze jednej kwestii technicznej: do sporządzenia regresji konieczne było unormowanie rozkładów wyników matur. Dzięki temu łatwiej można było porównywać wpływ badanych czynników na wyniki z różnych przedmiotów. Również pomiędzy latami zestawy pytań mogły nieco różnić się trudnością, więc unormowanie pomogło odróżnić wieloletnie trendy od losowych fluktuacji. [tu opis techniczny normowania - Piotr]

Analizę korelacji wykonano w języku *Python* korzystając z bibliotek [...]

```{r korelacje, echo = F, results = 'asis', anchor="figure"}
cat("![](korelacje.png)")

caption('korelacje', "Współczynniki korelacji różnych czynników z unormowanymi wynikami trzech obowiązkowych matur w latach 2010-2014. Czarne linie oznaczają odchylenia standardowe (pomiędzy latami?)")
```
...
Drugim czynnikiem silnie korelującym z wynikami był wiek maturzystów: im młodsi, tym uzyskiwali lepsze wyniki. Jako grupę odniesienia wykorzystano tu 19-latków, stanowiących najliczniejszą grupę wiekową. Co ciekawe, największe różnice, w przypadku osób mających ponad 20 lat, dotyczyły matematyki [jak to pogodzić z tym, że wśród absolwentów techników i szkół uzupełniających właśnie matematyka szła najlepiej?].
