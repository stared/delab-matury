...
Do tej wizualizacji użyto danych dotyczących maturzystów zdających maturę po raz pierwszy, ponieważ liczba osób piszących ten egzamin kolejny raz jest stosunkowo niewielka i często brakuje o nich części informacji. Do tworzenia omówionych histogramów potrzeba bardzo szczegółowych danych – ich zbiór jest na tyle duży, że wyraźnie spowalnia wizualizację. Aby ograniczyć czas wczytywania, użyto wyłącznie najświeższych danych, pochodzących z 2014 roku.
