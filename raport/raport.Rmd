...
* wyniki matur laureatów olimpiad,
...
Stworzyliśmy szereg interaktywnych wizualizacji danych, które pozwalają nie tylko zobaczyć znalezione trendy, ale szukać nowych. Wizualizacje są dostępne z poziomu przeglądarki internetowej i nie wymagają instalacji ani logowania. Tym samym pozwolają na samodzielną eksplorację wyników analiz. Są to:

* eksplorator histogramów matur, z podziałem na różne czynniki demograficzne,
* graf współzdawania matur,
* graf laureatów z więcej niż jednej olimpiady przedmiotowej równocześnie,
* mapa wyników matur w zależności od wojedzództwa.
