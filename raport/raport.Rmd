...
Projekt przewidywał przeanalizowanie danych z matur, składających się ze zanonimizowanych wyników z każdego zadania i dla 10 najczęściej zdawanych przedmiotów, z lat 2010-2014, połączonych z dodatkowymi danymi o szkołach [`r figr("ZPD", type="reference")`]. Pozwoliło to zbadać, jakie czynniki, związane z maturzystami i ukończonymi przez nich szkołami średnimi wpływają na wyniki matur. Umożliwiło również analizę zróżnicowania geograficznego uzyskanych wyników a także zbadanie wyboru przedmiotów dokonanego przez maturzystów.
...
Głównym celem projektu było przedstawienie danych maturalnych w postaci interaktnywch wizualizacji, które pozwoliły na eksplorację i wyciąganie wniosków z danych. Umożliwiają również atrakcyjne przedstawienie wyników, przystępne także dla osób mniej obeznanych z technikami analizy danych.
...
Podział ten odpowiada zapewne bardziej wymogom stawianym kandydatom przez uczelnie wyższe, niż powiązaniom między zainteresowaniami maturzystów. Pierwsza z wymienionych grup to prawdopodobnie osoby wybierające studia na politechnice i kierunki ścisłe na uniwersytetach. Druga to osoby zainteresowane kierunkami humanistycznymi oraz kształceniem z zakresu zarządzania i biznesu. Wreszcie trzecia grupa to prawdopodobnie kandydaci na kierunki medyczne, przyrodnicze lub rolnicze. Zapewne stosunkowo mało kierunków studiów oferuje możliwość łączenia tych trzech dziedzin wiedzy.
