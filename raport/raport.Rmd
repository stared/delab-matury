...
Niniejszy raport przedstawia rezultaty realizacji mikrograntu DELab UW "Analiza i interaktywna wizualizacja danych maturalnych", opracowane okresie kwiecień-lipiec 2015. Analizowaliśmy dane maturalne z lat 2010-2014 pochodzące z zbioru Zespołu Pomiaru Dydaktycznego Instytutu Badań Edukacyjnych. Prezentujemy tu główne wyniki oraz opisujemy stworzone wizualizacje: wspólnego wybierania matur, rozkładów wyników w zależności od czynników demograficznych i własności szkół średnich, porównaia wyników między województwami oraz uczestnictwa w olimpiadach przedmiotowych i ich związek z wynikami matur. 
...
```
[`r figr("IB", type="reference")`] International Baccalaureate Organization, http://www.ibo.org/en/country/PL/
