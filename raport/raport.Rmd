...
* Wśród przedmiotów do wyboru na maturze widać trzy grupy wspólnie wybieranych: humanistyczno-społeczne, ścisłe i przyrodnicze.

* Rozszerzony język angielski jest często łączony z przedmiotami rozszerzonymi z wszystkich trzech grup.
...
* Częściej wybierane przez dziewczęta są przedmioty przyrodnicze: biologia i chemia oraz WOS na obu poziomach i rozszerzony język polski.

* Częściej wybierane przez chłopców są przedmioty ścisłe (informatyka i fizyka na obu poziomach, rozszerzona matematyka) oraz historia na obu poziomach i podstawowa geografia.
...
* Im młodsi maturzyści, tym częściej uzyskiwali dobre wyniki.
