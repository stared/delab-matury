...
caption('korelacje_matur', "Współczynniki korelacji unormowanymi wyników matur z podstawowymi maturami z j. polskiego, matematyki i j. angielskiego.")
```
...
Wszystkie korelacje pomiędzy wynikami matur są dodatnie - t.j. nie ma par przedmiotów, w kótrych dobre radzenie sobie z jednym byłoby związane z kiepskim radzeniem sobie z innym. Szerzej porównaliśmy korelacje matur j. pol., mat. i j. ang. (ryc. `r figr("korelacje_matur", type="figure")`). Wyniki z matury podstawowej z j. polskiego miały najmniejsze korelacje z innymi wynikami (poniżej 0.6). Co więcej o ile w przypadku matematyki i j. angielskiego korelacje pomiędzy częścią podstawową a rozszerzoną były duże (powyżej 0.7), to dla j. polskiego była znacznie mniejsza (poniżej 0.5). 

Analiza współczynników regresji liniowej (ryc. `r figr("regresje", type="figure")`) w większości potwierdza wnioski uzyskane na podstawie histogramów. Dlatego tutaj podano jedynie poczynione obserwacje, bez powtarzania ich interpretacji, które czytelnik może znaleźć w poprzednim rozdziale.
